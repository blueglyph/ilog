...
impl IntLog for u128 {
    ...
    /// assert_eq!(thousand.log10(), 3);
    /// assert_eq!(u128::log10(999), 2);
    /// ```
    #[inline]
    fn log10(self) -> usize {
        let y = (77 * (127 - self.leading_zeros() as usize)) >> 8;
        y + (LOG10_U128_TABLE[y + 1].wrapping_sub(self) >> 127) as usize
    }
    ...
    /// let value: u128 = 256;
    /// assert_eq!(value.log2(), 8);
    /// assert_eq!(u128::log2(255), 7);
    /// ```
    #[inline]
    fn log2(self) -> usize {
        127 - self.leading_zeros() as usize
    }
}
